...
public:
    ...
    static void GenerateRoundClip(HDC hDC,
                                  RECT rc,
                                  RECT rcItem,
                                  int width,
                                  int height,
...
public:
    ...
    static TImageInfo* LoadImage(LPCTSTR pStrImage,
                                 LPCTSTR type = NULL,
                                 DWORD mask = 0,
                                 HINSTANCE instance = NULL);

    static TImageInfo* LoadImage(UINT nID,
                                 LPCTSTR type = NULL,
                                 DWORD mask = 0,
                                 HINSTANCE instance = NULL);
    ...
    static bool DrawImageInfo(HDC hDC,
    ...
    // Gdiplus绘制
    static TImageInfo* GdiplusLoadImage(STRINGorID bitmap,
                                        LPCTSTR type = NULL,
                                        DWORD mask = 0,
                                        HINSTANCE instance = NULL);

    static void GdiplusDrawImage(HDC hDC,
                                 Gdiplus::Image* image,
                                 const RECT& rc,
                                 const RECT& rcPaint,
                                 const RECT& rcBmpPart,
    ...
    static void GdiplusDrawText(HDC hDC,
                                CPaintManagerUI* pManager,
                                RECT& rc,
                                LPCTSTR pstrText,
                                DWORD dwTextColor,
    ...
    static void
    AdjustImage(bool bUseHSL, TImageInfo* imageInfo, short H, short S, short L);

    static HBITMAP GenerateBitmap(CPaintManagerUI* pManager,
                                  RECT rc,
