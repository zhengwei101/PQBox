...
{
    m_paintMgr.RemovePreMessageFilter(this);
    m_paintMgr.RemoveNotifier(this);
    m_paintMgr.ReapObjects(m_paintMgr.GetRoot());
}

CDuiString WindowImplBase::GetSkinType()
{
    return _T("");
}
...
LRESULT WindowImplBase::MessageHandler(UINT uMsg,
                                       WPARAM wParam,
                                       LPARAM /*lParam*/,
                                       bool& /*bHandled*/)
{
...
LRESULT WindowImplBase::OnDestroy(UINT /*uMsg*/,
                                  WPARAM /*wParam*/,
                                  LPARAM /*lParam*/,
                                  BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnNcActivate(UINT /*uMsg*/,
                                     WPARAM wParam,
                                     LPARAM /*lParam*/,
                                     BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnNcPaint(UINT /*uMsg*/,
                                  WPARAM /*wParam*/,
                                  LPARAM /*lParam*/,
                                  BOOL& /*bHandled*/)
{
...
LRESULT WindowImplBase::OnMouseWheel(UINT /*uMsg*/,
                                     WPARAM /*wParam*/,
                                     LPARAM /*lParam*/,
                                     BOOL& bHandled)
{
...
LRESULT
WindowImplBase::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    SIZE szRoundCorner = m_paintMgr.GetRoundCorner();
#if defined(WIN32) && !defined(UNDER_CE)
    if (!::IsIconic(*this))
    {
        CDuiRect rcWnd;
...
LRESULT
WindowImplBase::OnChar(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
                                 ...
                                 BOOL& bHandled)
{
    ...
    // 注册PreMessage回调
    m_paintMgr.AddPreMessageFilter(this);
    ...
    if (!sSkinType.IsEmpty())
    {
        ...
        pRoot = builder.Create(xml, sSkinType, this, &m_paintMgr);
    }
    else
    {
        pRoot = builder.Create(GetSkinFile().GetData(), NULL, this, &m_paintMgr);
    }
...
LRESULT WindowImplBase::OnKeyDown(UINT /*uMsg*/,
                                  WPARAM /*wParam*/,
                                  LPARAM /*lParam*/,
                                  BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnKillFocus(UINT /*uMsg*/,
                                    WPARAM /*wParam*/,
                                    LPARAM /*lParam*/,
                                    BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnSetFocus(UINT /*uMsg*/,
                                   WPARAM /*wParam*/,
                                   LPARAM /*lParam*/,
                                   BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnLButtonDown(UINT /*uMsg*/,
                                      WPARAM /*wParam*/,
                                      LPARAM /*lParam*/,
                                      BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnLButtonUp(UINT /*uMsg*/,
                                    WPARAM /*wParam*/,
                                    LPARAM /*lParam*/,
                                    BOOL& bHandled)
{
...
LRESULT WindowImplBase::OnMouseMove(UINT /*uMsg*/,
                                    WPARAM /*wParam*/,
                                    LPARAM /*lParam*/,
                                    BOOL& bHandled)
{
...
LRESULT
WindowImplBase::OnTimer(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
...
void WindowImplBase::OnWindowInit(TNotifyUI& msg)
{
    InitWindow();
}
