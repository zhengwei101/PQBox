...
//  	rename("IDispatchEx","IMyDispatchEx")	/* fix conflicting with
//  IDispatchEx ant dispex.h */
...
private:
    ...
    GetTypeInfoCount(__RPC__out UINT* pctinfo);
    virtual HRESULT STDMETHODCALLTYPE GetTypeInfo(
        UINT iTInfo, LCID lcid, __RPC__deref_out_opt ITypeInfo** ppTInfo);
    virtual HRESULT STDMETHODCALLTYPE
    GetIDsOfNames(__RPC__in REFIID riid,
