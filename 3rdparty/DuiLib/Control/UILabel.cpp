...
SIZE CLabelUI::EstimateSize(SIZE szAvailable)
{
    ...
    if ((szAvailable.cx != m_szAvailableLast.cx ||
         szAvailable.cy != m_szAvailableLast.cy))
    {
        m_bNeedEstimateSize = true;
    }
    ...
    if (m_bNeedEstimateSize)
    {
        ...
        if ((m_uTextStyle & DT_SINGLELINE) != 0)
        {
            ...
            {
                m_cxyFixedLast.cy =
                    m_pManager->GetFontInfo(m_iFont)->tm.tmHeight + 8;
                ...
                if (m_bAutoCalcWidth)
                {
                    ...
                    if (m_bShowHtml)
                    {
                        ...
                        CRenderEngine::DrawHtmlText(
                            ...
                            m_iFont,
                            DT_CALCRECT |
                                m_uTextStyle & ~DT_RIGHT & ~DT_CENTER);
                    }
                    else
                    {
                    ...
                    m_cxyFixedLast.cx =
                        ...
                        GetManager()->GetDPIObj()->Scale(m_rcTextPadding.left +
...
void CLabelUI::PaintText(HDC hDC)
{
    ...
    RECT rc = m_rcItem;
    RECT rcTextPadding = CLabelUI::m_rcTextPadding;
