...
public:
    ...
    virtual DWORD
    GetItemTextColor(CControlUI* pList,
                     int iItem,
                     int iSubItem,
                     int iState) = 0; // iState：0-正常、1-激活、2-选择、3-禁用
};
...
public:
    ...
    int GetItemIndex(CControlUI* pControl) const override;
    ...
    void EnableScrollBar(bool bEnableVertical = true,
        bool bEnableHorizontal = false) override;
...
class UILIB_API CListContainerElementUI : public CHorizontalLayoutUI,
                                          public IListItemUI
{
